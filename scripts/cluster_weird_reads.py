...
def main():
    ...
    cluster_weird_reads(in_weird_reads_file, out_file, tid2chrname_list, chrname2tid_dict, max_distance, min_n_short_read_supp, max_n_short_read_supp)


def cluster_weird_reads(in_weird_reads_file, out_file, tid2chrname_list, chrname2tid_dict, max_distance, min_n_short_read_supp, max_n_short_read_supp):
    ...
    cluster_weird_reads1type(short_read_support_list33, out_fp, min_n_short_read_supp, max_distance, tid2chrname_list, chrname2tid_dict, max_n_short_read_supp)
    cluster_weird_reads1type(short_read_support_list55, out_fp, min_n_short_read_supp, max_distance, tid2chrname_list, chrname2tid_dict, max_n_short_read_supp)
    cluster_weird_reads1type(short_read_support_list53, out_fp, min_n_short_read_supp, max_distance, tid2chrname_list, chrname2tid_dict, max_n_short_read_supp)
    cluster_weird_reads1type(short_read_support_list35, out_fp, min_n_short_read_supp, max_distance, tid2chrname_list, chrname2tid_dict, max_n_short_read_supp)

    out_fp.close()

    return

def cluster_weird_reads1type(short_read_support_list, out_fp, min_n_short_read_supp, max_distance, tid2chrname_list, chrname2tid_dict, max_n_short_read_supp):
