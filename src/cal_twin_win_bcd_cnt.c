...
static int cal_twin_win_bcd_cnt(const char * bcd21_file, const char * output_file, const char * faidx_file, int shift_size, int win_size)
{
	...
	read_pos_list  = init_int_list( MAX_READ_PER_CHROM_PER_BARCODE);
	seg_start_list = init_int_list( MAX_READ_PER_CHROM_PER_BARCODE);
	seg_end_list   = init_int_list( MAX_READ_PER_CHROM_PER_BARCODE);
	idx_list_win1  = init_int_list( MAX_READ_PER_CHROM_PER_BARCODE);
	idx_list_win2  = init_int_list( MAX_READ_PER_CHROM_PER_BARCODE);
	idx_list_ovl   = init_int_list( MAX_READ_PER_CHROM_PER_BARCODE);
